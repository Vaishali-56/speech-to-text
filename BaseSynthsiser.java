...
public class BaseSynthsiser {
     ...
     * @return Returns an input stream of the MP3 data 
     ...
     * @return Returns an input stream of all the MP3 data 
    ...
    /**
     * Separates a string into smaller parts 
